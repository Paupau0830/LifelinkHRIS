                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="basic_salary" id="basic_salary" required class="form-control" value="<?= $_SESSION['selected_edit_basicsalary'] ?>" step="any" onkeyup="calculateGross()">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="sss_ec" readonly class="form-control" value="<?= $_SESSION['selected_edit_sss_ec'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>SSS EE</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="sss_ee" readonly class="form-control" value="<?= $_SESSION['selected_edit_sss_ee'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>SSS ER</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="sss_er" readonly class="form-control" value="<?= $_SESSION['selected_edit_sss_er'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>HDMF EE</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="hdmf_ee" readonly class="form-control" value="<?= $_SESSION['selected_edit_hdmf_ee'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>HDMF ER</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="hdmf_er" readonly class="form-control" value="<?= $_SESSION['selected_edit_hdmf_er'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Philhealth EE</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="philhealth_ee" readonly class="form-control" value="<?= $_SESSION['selected_edit_philhealth_ee'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Philhealth ER</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="philhealth_er" readonly class="form-control" value="<?= $_SESSION['selected_edit_philhealth_er'] ?>" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Annual Medical Allowance</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="annual_medical_allowance" required class="form-control" step="any" value="<?= $_SESSION['selected_annual_medical_allowance'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Cost of Living Allowance (COLA)</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="cola" id="cola" required class="form-control" step="any" onkeyup="calculateGross()" value="<?= $_SESSION['selected_edit_cola'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Additional Allowance</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="additional_allowance" required class="form-control" step="any" value="<?= $_SESSION['selected_edit_additional_allowance'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Monthly Gross Salary</label>&nbsp;<span style="color:red;font-weight:bold">*</span>
                            <input type="number" name="monthly_gross" id="monthly_gross" readonly class="form-control" step="any" value="<?= $_SESSION['selected_edit_monthly_gross'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">

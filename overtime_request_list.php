...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-clock-o"></i><strong>Overtime Application<strong>
            </h1>
        </div>
    ...
    <div class="block full">
        ...
        <div class="container-fluid">
            ...
            <table id="two-column" class="table table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = mysqli_query($db, "SELECT * FROM tbl_ot_request WHERE approver = '$emp_num'");
                    ...
                    <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="overtime_request_list-view?<?= md5('id') . '=' . md5($row['id']) ?>" class="btn btn-primary">View</a>
                                </div>
                            </td>
                        </tr>
                    <?php

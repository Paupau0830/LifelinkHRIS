...
<div id="page-content">
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-heart"></i>Training Approvers
            </h1>
        </div>
    </div>
    <?= $res ?>
    <div class="block">
        <div class="block-title">
            <h2><strong>Add Training</strong> Approver</h2>
        </div>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="employee_number" class="select-chosen" data-placeholder="Select Approver">
                        ...
                        $users = get_users();
                        $curr_users = array();
                        $get_current_approvers = mysqli_query($db, "SELECT * FROM tbl_training_approvers WHERE company_id = '$company_id'");
                ...
                <div class="form-group">
                    <button name="add_training_approver" class="btn btn-primary">Submit</button>
                </div>
            </form>
        </div>
    </div>
    <div class="block full">
        ...
        <div class="table-responsive">
            <table id="training-approver" class="table table-vcenter table-condensed table-bordered">
                <thead>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form method="POST">
                                    ...
                                    <button class="btn btn-sm btn-danger" name="btn_delete_training_approver"><i class="fa fa-trash"></i></button>
                                </form>
                            </td>
                        </tr>
                    <?php

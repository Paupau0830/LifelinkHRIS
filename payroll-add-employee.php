                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="emp_num" required class="form-control"
                                value="<?= $_SESSION['add_payroll_empnum'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" readonly name="emp_name" required class="form-control"
                            value="<?= $_SESSION['add_payroll_empname'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="select_company" required class="form-control"
                                value="<?= $_SESSION['add_payroll_empcomp'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="job_title" required class="form-control"
                                value="<?= $_SESSION['add_payroll_empjob'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="basic_salary" id="basic_salary" required class="form-control"
                                step="any" onkeyup="calculateGross()">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Cost of Living Allowance (COLA)</label>&nbsp;<span
                                style="color:red;font-weight:bold">*</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="additional_allowance" required class="form-control" step="any">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">

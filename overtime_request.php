    ...
    <div class="content-header">
      ...
      <div class="block full">
        <div class="block-title">
            <h2><strong>Overtime Request</strong> Form</h2>
        </div>
        <div class="container-fluid">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button class="btn btn-primary" name="btn_request_ot">Submit</button>
            </form>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="overtime_request_list-viewonly?<?= md5('id') . '=' . md5($row['id']) ?>" class="btn btn-primary">View</a>
                                </div>
                            </td>
                        </tr>
                    <?php

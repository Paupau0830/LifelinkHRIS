...
<div id="page-content" onLoad="renderTime();">
    ...
    <div class="content-header">
        ...
        <center><div id="timeDisplay" name="timenow"  class="date-container" style="font-size:30px; font-weight:800;">
        </div></center>
        </div>
    ...
    <button type="submit" id="btntimein" name="btn_timeinout" class="btn btn-lg btn-primary" 
    <?php if($_SESSION['btn_disabled'] == true) 
    {
       echo 'disabled';
    }
  ?>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" class="form-horizontal form-bordered">
                        ...
                        <button class="btn btn-primary" name="print_attendance_summary">Confirm</button>
                        <br>
                        <br>
                    </form>
                </div>

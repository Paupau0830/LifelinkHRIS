    ...
    <div class="block full">
        ...
        <div class="container-fluid">
            ...
            <table id="two-column" class="table table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = mysqli_query($db, "SELECT * FROM tbl_attendance_adjust_request WHERE approver = '$emp_num'");
                    ...
                    <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="attendance_adjustment_request-view?<?= md5('id') . '=' . md5($row['id']) ?>" class="btn btn-primary">View</a>
                                </div>
                            </td>
                        </tr>
                    <?php

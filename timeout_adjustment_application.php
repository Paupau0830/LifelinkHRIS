    ...
    <div class="content-header">
        <div class="header-section">
           ...
           <ul class="nav-horizontal text-center">
                  <li>
                  <a href="timein_adjustment_application"><i class="fa fa-clock-o" style="margin-right: 3px;"></i> Time in</a></li>
                  </li>
                  <li  class="active">
                      <a href="#"><i class="fa fa-clock-o"></i> Time out</a>
                  </li>
      ...
      <div class="block full">
        <div class="block-title">
            <h2><strong>Time Out Adjustment</strong> Form</h2>
        </div>
        <div class="container-fluid">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button class="btn btn-primary" name="btn_timeout_request">Submit</button>
            </form>
        </div>
    </div>
    ...
    <div class="block full">
        ...
        <div class="container-fluid">
            ...
            <table id="two-column" class="table table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = mysqli_query($db, "SELECT * FROM tbl_attendance_adjust_request WHERE emp_num = '$emp_num' AND request_type = 'Time Out'");
                    while ($row = mysqli_fetch_assoc($sql)) {
                    ?>
                    <tr>
